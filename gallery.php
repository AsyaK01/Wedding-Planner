...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <h4 class="text-center mb-0 mt-5">СВАТБЕНАТА НИ ГАЛЕРИЯ</h4>
            <p class="text-center mt-0 text-muted">Всяка сватба е уникална приказка, изпълнена с любов, емоции и неповторими детайли. Нашата мисия е да уловим тези специални мигове и да ги превърнем във вечни спомени, които ще разказват историята на вашата любов за поколения напред. С внимание към всеки детайл и страст към красотата, ние създаваме съвършени фотографии, които отразяват истинската същност на вашия ден.</p>
