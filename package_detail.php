...
if (isset($_GET['id'])) {
    ...
    if (is_numeric($id)) {
        ...
        echo "Invalid ID format. Please provide a numeric ID.";
    }
} else {
        ...
        <div class="col-md-8 p-0" style="margin-bottom: 20px;"> 
            ...
            <div class="float-left bg-white">
                <h5 class="h5 text-uppercase mb-5 pt-3 pl-3 pr-3">
                    <span class="float-left text-capitalize"><?= $category->wedding_type; ?> Сватбен пакет</span>
                    <span class="float-right text-capitalize">Цена: $ <?= number_format($category->price,2); ?></span>
                </h5>
                ...
                <ul class="list-group">
                        <li class="list-group-item list-group-item-action bg-danger flex-column align-items-start active">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1 pt-2 pb-2">ФУНКЦИИ И УСЛУГИ</h5>
                            </div>
                        </li>
            ...
            <div class="col-md-4" style="margin-bottom: 20px;">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" style="background: white;padding: 20px;">
                        ...
                        ?>
                         <h5 class="h5 text-center mb-3 m-0">Планирането на сватбата започва тук</h5>
                        ...
                        <div class="form-group">
                            <input type="number" id="user_phone" class="form-control" name="user_phone" placeholder="Телефон">
                        </div>
                        ...
                        <div class="text-center mt-3">
                            ...
                            <button type="submit" name="register" class="btn btn-success btn-sm text-uppercase font-weight-bold"
                                    style="margin-top: -5px;">Резервирай сега
                            </button>
                        </div>
                    </form>
            </div>
