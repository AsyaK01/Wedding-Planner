        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="">
                    ...
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Редактиране на информацията за клиента
                        <a href="client.php" class="btn btn-sm btn-danger float-right" style="font-size: 12px;"><i class="mdi mdi-close-circle mr-2"></i> Затвори</a>
                    ...
                    <div class="form-row form-group">
                        ...
                        <div class="col-md-6">
                            <label for="wedding_type">Сватбен пакет</label>
                        </div>
