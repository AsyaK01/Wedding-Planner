        ...
        <div class="row">
            ...
            <div class="col-lg-8 pl-3 pb-3 box-shadow mt-4">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <?= isset($msg) ? $msg : ''; ?>
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Нова статия 
                        ...
                        <div class="form-group">
                            <label for="booking_id">Сватбен пакет:</label>
                        ...
                        <div class="form-group">
                            <label for="wedding_post">Свързан сватбен пост:</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" cols="30" rows="10" class="form-control" placeholder="Въведете описание на тази сватба"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="location" class="form-control"  id="location" placeholder="Въведете локация">
                    </div>
