    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4 pt-3">
                <h5>Качване на ново изображение</h5>
                <?= (isset($msg) ? $msg : ''); ?>
                <form method="post" action="" enctype="multipart/form-data">

                    <div class="form-group">
                        <label for="booking_id">Свързано с:</label>
                   ...
                   <div class="form-group">
                       ...
                       <input type="text" name="title" class="form-control" placeholder="Въведете заглавие">
                   </div>
                   <div class="form-group">
                       <label for="">Подзаглавие:</label>
                       <input type="text" name="caption" value="<?= $gallery->caption; ?>" class="form-control" placeholder="Въведете текст">
                   </div>
                    <div class="form-group">
                       <label for="">Алтернативен текст:</label>
                       <input type="text" name="alternate_text" value="<?= $gallery->alternate_text; ?>" class="form-control" placeholder="Въведете текст">
                   </div>
                   <div class="form-group">
                       <textarea name="description" rows="10" class="form-control" placeholder="Въведете текст"><?= $gallery->description; ?></textarea>
                   </div>
                   <div class="form-group">
                       <input type="file" name="file">
                   </div>
                   <button type="submit" name="submit" value="" class="btn btn-success btn-sm">Запазване на изображението</button>
                   <a href="photos_view.php" class="btn btn-danger btn-sm">Назад</a>
                </form>
<br>
                <h5 class="h5">Или плъзнете вашите изображения</h5>
