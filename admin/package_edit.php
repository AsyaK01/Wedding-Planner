        ...
        <div class="row">
            ...
            <div class="col-lg-8 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Редактиране на пакет</h4>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="wedding_type" class="form-control" id="wedding_type"  placeholder="Въведете име на пакета" value="<?= $category->wedding_type ?>">
                    </div>

                    <div class="form-group">
                        <label for="price">Цена на този пакет</label>
                        <input type="text" name="price" class="form-control" id="price"  placeholder="Въведете цена"  value="<?= $category->price ?>">
                    </div>
                   ...
                   <button type="submit" name="submit" class="btn btn-sm btn-success float-right mr-2" style="font-size: 12px;">Редактирай</button>
