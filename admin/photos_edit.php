    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 pl-3 pb-3 box-shadow mt-4 pt-3">
                <h5>Редактиране на изображението</h5>
                <?= (isset($msg) ? $msg : ''); ?>
                <form method="post" action="" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="booking_id">Изображение на двойката</label>
                   ...
                   <input type="submit" name="submit" value="Редактирай" class="btn btn-light btn-sm">
                   <input type="reset" name="Clear" class="btn btn-danger btn-sm">
                   <a href="photos_view.php" class="btn btn-light btn-sm float-right">Назад</a>
                </form>
            </div>
            <style>
                .photos-view {
