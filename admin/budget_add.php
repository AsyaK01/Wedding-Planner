    ...
    if (isset($_POST['submit'])) {
        ...
        $session->message("
            <div class=\"alert alert-success alert-dismissible fade show\" role=\"alert\">
              <strong><i class='mdi mdi-check'></i></strong> Успешно добавено.
              <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
                <span aria-hidden=\"true\">&times;</span>
              </button>
            </div>");
        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="">
                    ...
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Добавяне на бюджет</h4>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="payment" class="form-control" id="payment"  placeholder="Заплатено">
                    </div>

                    <div class="form-group">
                        <label for="cash">Пари в брой:</label>
                        <input type="text" name="cash" class="form-control" id="cash"  placeholder="Пари в брой">
                    </div>
