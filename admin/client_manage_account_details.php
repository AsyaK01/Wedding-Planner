...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h6 class="h6 mt-4 text-uppercase">ПРЕГЛЕД на <?= @ucfirst($category_details->wedding_type == 0) ? $category_details->wedding_type . " Package Wedding" : 'No Package Selected'; ?> </h6>
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            ...
            <a class="btn btn-sm btn-info mr-2 " style="font-size: 12px;" href="guest_list.php?<?= $links; ?>"><i class="mdi mdi-account-network mr-2"></i> Основен списък с гости</a>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                    <div class="card-header">Общо гости</div>
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                    ...
                    <div class="card-header">Сума, платена до момента</div>
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                    <div class="card-header">Дължима сума</div>
                    <div class="card-body">
...
<div class="row">
    <div class="col-md-12 mb-3">
        <ul class="list-group">
            <li class="list-group-item active bg-danger">Пакетът включва:</li>
