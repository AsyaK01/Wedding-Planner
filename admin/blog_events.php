...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h4 class="h4 mt-4 ml-3">Информация за събития и сватби</h4>
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            <a class="btn btn-md btn-success" style="font-size: 12px;" href="blog_events_add.php"><i class="mdi mdi-account-plus mr-2"></i> Добави ново</a>
        </div>
    </div>
</div>
    ...
    <tbody>
       <?php foreach ($event_wedding as $events) : ?>
        <tr>
            ...
            <td class="special"><?= ($events->status == 0) ? 'Чернова' : 'Публикувано'; ?></td>
