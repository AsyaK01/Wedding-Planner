...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
      <h5 class="h4 mt-4 ml-3" style="text-align: center;">Активности по сватбения календар</h5>
</div>
          ...
          <div class="modal-dialog" role="document">
            ...
            <form class="form-horizontal" method="POST" action="task_event_save.php">
              ...
              <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Добави събитие</h4>
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      <label for="booking_id">Двойка:</label>
                  ...
                  <div class="form-group">
                      <input type="text" name="title" class="form-control" id="title" placeholder="Заглавие на събитието">
                  </div>

                  <div class="form-group">
                    <input type="text" name="location" class="form-control" id="location" placeholder="Място">
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <select name="color" class="form-control" id="color">
                          ...
                          <option value="">Избор на цвят</option>
                    ...
                    <div class="form-group">
                        <label for="start" class="">Начална дата:</label>
                        <input type="text" name="start" class="form-control" id="start" readonly>
                    </div>

                  <div class="form-group">
                    <label for="end" class=" ">Крайна дата:</label>
