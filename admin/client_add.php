        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                ...
                <form action="client_add.php" method="post">
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Информация за нов клиент
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="lastname" class="form-control" id="inputLastname" placeholder="Въведете фамилия">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="">Име на булката</label>
                    ...
                    <div class="form-group">
                        <label for="">Име на младоженеца</label>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="">Телефонен номер</label>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="">Назначен организатор</label>
