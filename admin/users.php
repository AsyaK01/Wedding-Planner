...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h4 class="h4 mt-4 ml-3">Управление на служителите</h4>
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            <a class="btn btn-md btn-success" style="font-size: 12px;" href="users_add.php"><i class="mdi mdi-account-plus mr-2"></i> Добави Нов</a>
        </div>
    </div>
</div>
<?php
        ...
        <tr>
            ...
            <td>
                <a href="users_edit.php?id=<?= $user->id; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="
                    Редактирай"><i class="mdi mdi-pencil"></i></a>

                <a href="users_delete.php?id=<?= $user->id; ?>" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Изтрий този служител"><i class="mdi mdi-delete"></i></a>
            </td>
        </tr>
