...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            <a class="btn btn-sm btn-primary mr-2 active" style="font-size: 12px;" href="client_manage_account_details.php?<?= $links; ?>"><i class="mdi mdi-buffer mr-2"></i> Общ преглед</a>

            <a class="btn btn-sm btn-info mr-2 active" style="font-size: 12px;" href="guest_list.php?<?= $links; ?>"><i class="mdi mdi-account-plus mr-2"></i> Основен списък на гости</a>

            <a class="btn btn-sm btn-success mr-2 active" style="font-size: 12px;" href="budget.php?<?= $links; ?>"><i class="mdi mdi-currency-usd mr-2"></i> Бюджет</a>


            <a class="btn btn-sm btn-warning mr-2 active" style="font-size: 12px;" href="task_calendar.php?<?= $links; ?>"><i class="mdi mdi-calendar-text mr-2"></i> Календар</a>
...
<div class="text-right">
    ...
    <a class="btn btn-sm btn-success mr-2 active mb-3" style="font-size: 12px;" href="budget_add.php?<?= $links; ?>"><i class="mdi mdi-plus mr-2"></i> Добави</a>
...
<table id="liquidate" class="table table-striped table-hover table-bordered table-sm" cellspacing="0" width="100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="budget_edit.php?<?= $links; ?>&budget_id=<?= $luquidate_item->booking_id;?>" class="btn btn-warning btn-sm" style="font-size: 12px;">Промени</a>
            </td>
        </tr>
    <?php endforeach; ?>
