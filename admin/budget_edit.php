        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="">
                    ...
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Ликвидиране за
                        <span class="text-right"><a href="budget.php?<?=$links; ?>" class="btn btn-sm btn-light active float-right" style="font-size: 12px;">Назад</a></span>
                    </h4>

                    <?= ($session->message()) ? $session->message() : ''; ?>

                     <div class="form-group">
                        <label for="event_id">Събитие, свързано с:</label>
                    ...
                    <div class="form-group">
                        <label for="payment">Заплатено:</label>
                        <input type="text" name="payment" class="form-control" value="<?= $luquidate->payment; ?>" id="payment"  placeholder="Заплатено">
                    </div>

                    <div class="form-group">
                        <label for="cash">Пари в брой:</label>
                        <input type="text" name="cash" class="form-control" id="cash" value="<?= $luquidate->cash; ?>"  placeholder="Пари в брой">
                    </div>


                    <a href="budget.php?<?=$links; ?>" class="btn btn-sm btn-danger float-right" style="font-size: 12px;">Затвори</a>
                    <button type="submit" name="submit" class="btn btn-sm btn-light float-right mr-2" style="font-size: 12px;">Промени</button>
