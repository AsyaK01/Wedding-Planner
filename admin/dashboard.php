...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h4 class="h4 mt-4">Добре дошли, <?= ucfirst($users_profile->firstname) . ' ' . ucfirst($users_profile->lastname); ?></h4>
</div>
    ...
    <div class="col-lg-3">
      <div class="card-counter primary">
        ...
        <span class="count-name">Клиенти</span>
      </div>
    </div>
    ...
    <div class="col-lg-3">
      <div class="card-counter success">
        ...
        <span class="count-name">Резервации</span>
      </div>
    </div>
    ...
    <div class="col-lg-3">
      <div class="card-counter danger">
        ...
        <span class="count-name">Снимки</span>
      </div>
    </div>
    ...
    <div class="col-lg-3">
      <div class="card-counter info">
        ...
        <span class="count-name">Събития</span>
      </div>
    </div>
  </div>
  ...
  <div class="row mt-4">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Потребителски растеж</h5>
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Резервации във времето</h5>
