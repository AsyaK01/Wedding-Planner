        ...
        if ($event_wedding) {
            ...
            if (empty($title) || empty($description) || empty($wedding_date) || empty($location)) {
                ...
                <div class=\"alert alert-danger alert-dismissible fade show\" role=\"alert\">
                  <strong><i class='mdi mdi-account-alert mr-2'></i></strong> Моля, попълнете цялата информация.
            ...
            if(empty($_FILES['preview_image'])){
                ...
                <div class=\"alert alert-success alert-dismissible fade show\" role=\"alert\">
                  <strong><i class='mdi mdi-account-alert mr-2'></i></strong> Заглавието на {$event_wedding->title} е актуализирано.
                  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
                    <span aria-hidden=\"true\">&times;</span>
                  </button>
                </div>");
        ...
        <div class="row">
            ...
            <div class="col-lg-8 pl-3 pb-3 box-shadow mt-4">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Редактирай

                        <a href="blog_events.php" class="btn btn-sm btn-danger float-right" style="font-size: 12px;"><i class="mdi mdi-close-circle mr-2"></i> Затвори</a>
                        ...
                        <div class="form-group">
                            <label for="booking_id">Свързано:</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" cols="30" rows="10" class="form-control" placeholder="Въведете описание на тази сватба"><?= $event_wedding->description; ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <input type="text" class="form-control"
                                   ...
                                   placeholder="Дата на сватбата" value="<?= $event_wedding->wedding_date; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="location" class="form-control" value="<?= $event_wedding->location; ?>" id="location" placeholder="Въведете локация">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control">
                            <?php if($event_wedding->status == '0') : ?>
                                <option value="0" selected>Чернова</option>
                                <option value="1">Публикувано</option>
                            <?php else : ?>
                                <option value="0">Чернова</option>
                                <option value="1" selected>Публикувано</option>
                            <?php endif; ?>
                        </select>
                    </div>
