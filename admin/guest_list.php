...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h4 class="h4 mt-4">Основен списък на гостите</h4>
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            ...
            <a class="btn btn-sm btn-info mr-2 " style="font-size: 12px;" href="guest_list.php?<?= $links; ?>"><i class="mdi mdi-account-plus mr-2"></i> Основен списък гости</a>
...
<div class="text-right mr-2 mb-3">
    <a class="btn btn-sm btn-success mr-2" href="guest_add.php?<?= $links; ?>"><i class="mdi mdi-account-plus mr-2"></i> Добавяне на нов гост</a>
</div>
<table id="guest_list" class="table table-striped table-hover table-bordered table-sm" cellspacing="0" width="100%" style="background: white;padding: 0 5px;">
    ...
    <thead>
        <tr>
        <th>Пълно име</th>
            <th>Кратко име на госта</th>
            <th>Адрес</th>
            <th>Град</th>
            <th>Държава</th>
            <th>Пощенски код</th>
            <th>Тип на приоритета</th>
            <th>Извън града</th>
            <th>Връзка с</th>
            <th>Проследяване на подаръци &amp; Благодарности</th>
            <th>Инструменти</th>
        </tr>
    </thead>
